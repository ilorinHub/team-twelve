...
<main id="main" class="main">
  <div class="pagetitle">
    <h1 class="text-success"><?= $org_name ?> Profile's</h1>
    ...
    <div class="card-body">
      ...
      <ul class="nav nav-tabs pt-2" id="myTab" role="tablist">
        <li class="nav-item" role="presentation">
          <button class="nav-link active text-success" id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile" type="button" role="tab" aria-controls="profile" aria-selected="true">Payment Logs</button>
        </li>
      </ul>
